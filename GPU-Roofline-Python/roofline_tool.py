...
def create_graph(memories):
    ...
    peak = 912.9 # theoretical peak for 1050ti Mobile

    # l1_bw = 437.5 # theoretical bandwidth of L1 for V100S
    # l1_bw = 1312.5 # theoretical bandwidth of L1 for A100
    l1_bw = 59.4 # theoretical bandwidth of L1 for 1050ti Mobile
    l1_elbow = peak/l1_bw

    # l2_bw = 93.6 # theoretical bandwidth of L2 for V100S
    # l2_bw = 215.3 # theoretical bandwidth of L2 for 1050ti Mobile
    l2_bw = 122.95 # theoretical bandwidth of L2 for 1050ti Mobile
    
    l2_elbow = peak/l2_bw

    # hbm_bw = 25.9 # theoretical bandwidth of HBM for V100S
    # hbm_bw = 48.6  # theoretical bandwidth of HBM for A100
    hbm_bw = 3.023482  # theoretical bandwidth of HBM for 1050ti Mobile
    ...
    peak_x = np.asarray([l2_elbow, 10**xmax]) # performance ceiling
...
def timing(kernel_stats, kernel_name, time_file, profiler):
    ...
    if unit == 'msecond':
        ...
        kernel_time *= 1000000  #peak = 489.6 # theoretical peak for V100S in warp GIPS
    ...
    #hbm_bw = 25.9 # theoretical bandwidth of HBM for V100S
    #hbm_bw = 48.6  # theoretical bandwidth of HBM for A100
    hbm_bw = 3.02  # theoretical bandwidth of HBM for 1050ti Mobile
...
if __name__ == "__main__":
    ...
    import sys
    if len(sys.argv) != 2:
        print("Usage: python roofline_tool.py <kernel_version_name>")
        sys.exit()
    else:
    ...
    timings = "compiler_metrics/timing_exe.csv"
    events = "compiler_metrics/events_exe.csv"
    metrics = "compiler_metrics/metrics_exe.csv"
